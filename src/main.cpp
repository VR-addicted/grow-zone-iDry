...
void onEspNowDataRecv(const uint8_t *mac_addr, const uint8_t *data, int data_len) {
  ...
  if (msg.type == 0 && sysConfig.espnow_role == 2 && (isPairingActive || strlen(sysConfig.espnow_peer_mac) == 0)) {
...
static const uint8_t IDRY_PMK[16] = {0x69, 0x44, 0x72, 0x79, 0x32, 0x36, 0x5F, 0x50, 0x4D, 0x4B, 0x5F, 0x53, 0x45, 0x43, 0x52, 0x45};
...
void initEspNow() {
  ...
  if (strlen(sysConfig.espnow_peer_mac) > 0) {
    ...
    peerInfo.channel = (sysConfig.espnow_role == 1) ? (WiFi.status() == WL_CONNECTED ? WiFi.channel() : 1) : sysConfig.espnow_channel;
    ...
    if (sysConfig.espnow_role == 1 && !isPairingActive) {
      ...
      esp_now_send(peerInfo.peer_addr, (uint8_t *)&pingMsg, sizeof(EspNowMessage));
    }
  }
}
...
const uint8_t favicon_png[4191] PROGMEM = {
  ...
  0x39, 0x2E, 0x31, 0x36, 0x34, 0x36, 0x34, 0x38, 0x2C, 0x20, 0x32, 0x30, 0x32, 0x31, 0x2F, 0x30, 
  0x31, 0x2F, 0x31, 0x32, 0x2D, 0x31, 0x35, 0x3A, 0x35, 0x32, 0x3A, 0x32, 0x39, 0x20, 0x20, 0x20, 
  ...
  , 
  ...
  0x3A, 0x70, 0x68, 0x6F, 0x74, 0x6F, 0x73, 0x68, 0x6F, 0x70, 0x3A, 0x35, 0x64, 0x33, 0x37, 0x61, 
  0x35, 0x35, 0x34, 0x2D, 0x31, 0x61, 0x38, 0x38, 0x2D, 0x35, 0x35, 0x34, 0x37, 0x2D, 0x39, 0x63, 
  0x39, 0x37, 0x2D, 0x36, 0x66, 0x62, 0x33, 0x38, 0x33, 0x38, 0x30, 0x33, 0x65, 0x33, 0x33, 0x22, 
  ...
  0x69, 0x64, 0x3A, 0x63, 0x31, 0x34, 0x62, 0x32, 0x64, 0x39, 0x39, 0x2D, 0x36, 0x62, 0x66, 0x62, 
  0x2D, 0x35, 0x64, 0x34, 0x33, 0x2D, 0x61, 0x31, 0x36, 0x32, 0x2D, 0x36, 0x36, 0x31, 0x62, 0x36, 
  0x32, 0x64, 0x33, 0x33, 0x35, 0x64, 0x31, 0x22, 0x20, 0x64, 0x63, 0x3A, 0x66, 0x6F, 0x72, 0x6D, 
  ...
  0x44, 0x3D, 0x22, 0x78, 0x6D, 0x70, 0x2E, 0x69, 0x69, 0x64, 0x3A, 0x63, 0x31, 0x34, 0x62, 0x32, 
  0x64, 0x39, 0x39, 0x2D, 0x36, 0x62, 0x66, 0x62, 0x2D, 0x35, 0x64, 0x34, 0x33, 0x2D, 0x61, 0x31, 
  0x36, 0x32, 0x2D, 0x36, 0x36, 0x31, 0x62, 0x36, 0x32, 0x64, 0x33, 0x33, 0x35, 0x64, 0x31, 0x22, 
  ...
  0x70, 0x2E, 0x69, 0x69, 0x64, 0x3A, 0x34, 0x64, 0x62, 0x33, 0x64, 0x33, 0x31, 0x35, 0x2D, 0x64, 
  0x31, 0x33, 0x62, 0x2D, 0x64, 0x64, 0x34, 0x39, 0x2D, 0x38, 0x39, 0x31, 0x64, 0x2D, 0x32, 0x61, 
  0x65, 0x62, 0x33, 0x64, 0x62, 0x30, 0x36, 0x36, 0x34, 0x30, 0x22, 0x20, 0x73, 0x74, 0x45, 0x76, 
  ...
  0x6F, 0x74, 0x6F, 0x73, 0x68, 0x6F, 0x70, 0x20, 0x32, 0x32, 0x2E, 0x32, 0x20, 0x28, 0x57, 0x69, 
  ...
  
};
...
void handleGetData() {
  ...
  doc["espnow_pv_mismatch"] = (strlen(sysConfig.espnow_peer_mac) > 0) && (remoteProtocolVersion > 0) && (remoteProtocolVersion != localProtocolVersion);
...
void handleSettingsSave() {
  ...
  // Protect existing paired MAC from being wiped by form submit of empty/disabled field
...
void handleFavicon() {
  ...
  if (server.uri().endsWith(".ico")) {
    server.send_P(200, "image/x-icon", (const char *)favicon_png, sizeof(favicon_png));
  } else {
    server.send_P(200, "image/png", (const char *)favicon_png, sizeof(favicon_png));
  }
}
...
int fetchGithubFirmwareVersion() {
  ...
  if (http.begin(client, "https://raw.githubusercontent.com/VR-addicted/grow-zone-iDry/main/FIRMWARE/version.txt")) {
...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="info-text">
                Installiere Version: <strong>)rawhtml";
  html += String(localFirmwareVersion);
  html += R"rawhtml(</strong> &nbsp;|&nbsp; Aktuellste Version: <strong>)rawhtml";
  if (onlineVersion > 0) {
